...
namespace NFTCreater.NFT
{
    public static class Constants
    {
        ...
        public const string ImagesFolderName = "NftImages";
        public const int MaxDuplicateDnaRetries = 100;
        public static readonly string[] SupportedImageFormats = new[] { "*.jpg", "*.jpeg", "*.png" };

        public static class About
        {
            public const string SiteUrl = "https://space.bilibili.com/2069281760?spm_id_from=333.337.0.0";
            public const string MySide = "https://linktr.ee/seanan";
